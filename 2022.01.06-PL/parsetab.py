...
_lr_productions = [
  ...
  ('portugol -> func_list ; inicio code','portugol',4,'p_portugol','logic_grammar.py',40),
  ('func_list -> func','func_list',1,'p_func_list','logic_grammar.py',44),
  ('func_list -> func_list ; func','func_list',3,'p_func_list','logic_grammar.py',45),
  ('func -> funcao var ( args ) com_list ; fimfuncao','func',8,'p_func','logic_grammar.py',53),
  ('portugol -> inicio code','portugol',2,'p_portugol2','logic_grammar.py',61),
  ('code -> s','code',1,'p_code1','logic_grammar.py',65),
  ('code -> code ; s','code',3,'p_code2','logic_grammar.py',69),
  ('s -> comando','s',1,'p_s','logic_grammar.py',74),
  ('s -> fim','s',1,'p_s','logic_grammar.py',75),
  ('ciclo -> para var de e ate e faca com_list ; fimpara','ciclo',10,'p_ciclo','logic_grammar.py',89),
  ('ciclo -> enquanto n faca com_list ; fimenquanto','ciclo',6,'p_ciclo2','logic_grammar.py',97),
  ('comando -> e','comando',1,'p_comando1','logic_grammar.py',109),
  ('comando -> ciclo','comando',1,'p_comando1','logic_grammar.py',110),
  ('comando -> var assign e','comando',3,'p_comando2','logic_grammar.py',114),
  ('comando -> escreva ( e_list )','comando',4,'p_comando3','logic_grammar.py',119),
  ('comando -> leia ( var_list )','comando',4,'p_comando4','logic_grammar.py',124),
  ('comando -> vartype : var_list','comando',3,'p_comando5','logic_grammar.py',128),
  ('comando -> se e entao com_list ; senao com_list ; fimse','comando',9,'p_comando6','logic_grammar.py',134),
  ('comando -> se e entao com_list ; fimse','comando',6,'p_comando7','logic_grammar.py',140),
  ('com_list -> comando','com_list',1,'p_com_list','logic_grammar.py',147),
  ('com_list -> com_list ; comando','com_list',3,'p_com_list','logic_grammar.py',148),
  ('e_list -> e','e_list',1,'p_e_list','logic_grammar.py',158),
  ('e_list -> e_list , e','e_list',3,'p_e_list','logic_grammar.py',159),
  ('e -> var','e',1,'p_e1','logic_grammar.py',168),
  ('e -> ( e )','e',3,'p_e2','logic_grammar.py',172),
  ('e -> b','e',1,'p_e3','logic_grammar.py',176),
  ('e -> n','e',1,'p_e3','logic_grammar.py',177),
  ('e -> string','e',1,'p_e3','logic_grammar.py',178),
  ('e -> var ( e_list )','e',4,'p_e4','logic_grammar.py',182),
  ('e -> var ( )','e',3,'p_e4','logic_grammar.py',183),
  ('n -> nr','n',1,'p_n1','logic_grammar.py',191),
  ('n -> - e','n',2,'p_n1','logic_grammar.py',192),
  ('n -> ( n )','n',3,'p_n2','logic_grammar.py',196),
  ('n -> e + e','n',3,'p_n3','logic_grammar.py',200),
  ('n -> e - e','n',3,'p_n3','logic_grammar.py',201),
  ('n -> e * e','n',3,'p_n3','logic_grammar.py',202),
  ('n -> e / e','n',3,'p_n3','logic_grammar.py',203),
  ('n -> e < e','n',3,'p_n4','logic_grammar.py',207),
  ('n -> e leq e','n',3,'p_n4','logic_grammar.py',208),
  ('n -> e > e','n',3,'p_n4','logic_grammar.py',209),
  ('n -> e geq e','n',3,'p_n4','logic_grammar.py',210),
  ('n -> e = e','n',3,'p_n4','logic_grammar.py',211),
  ('n -> e dif e','n',3,'p_n4','logic_grammar.py',212),
  ('b -> f','b',1,'p_b1','logic_grammar.py',218),
  ('b -> e or e','b',3,'p_b1','logic_grammar.py',219),
  ('b -> e and e','b',3,'p_b1','logic_grammar.py',220),
  ('b -> e xor e','b',3,'p_b1','logic_grammar.py',221),
  ('f -> true','f',1,'p_f1','logic_grammar.py',230),
  ('f -> false','f',1,'p_f2','logic_grammar.py',234),
  ('f -> not f','f',2,'p_f3','logic_grammar.py',238),
  ('var_list -> var','var_list',1,'p_var_list','logic_grammar.py',244),
  ('var_list -> var_list , var','var_list',3,'p_var_list','logic_grammar.py',245),
  ('args -> <empty>','args',0,'p_args','logic_grammar.py',255),
  ('args -> var_list','args',1,'p_args','logic_grammar.py',256),
]
