...
_lr_productions = [
  ...
  ('portugol -> func_list ; inicio code','portugol',4,'p_portugol','logic_grammar.py',39),
  ('portugol -> inicio code','portugol',2,'p_portugol2','logic_grammar.py',43),
  ('func_list -> func','func_list',1,'p_func_list','logic_grammar.py',49),
  ('func_list -> func_list ; func','func_list',3,'p_func_list','logic_grammar.py',50),
  ('func -> funcao var ( args ) com_list ; fimfuncao','func',8,'p_func','logic_grammar.py',58),
  ('code -> s','code',1,'p_code1','logic_grammar.py',68),
  ('code -> code ; s','code',3,'p_code2','logic_grammar.py',72),
  ('s -> comando','s',1,'p_s','logic_grammar.py',78),
  ('s -> fim','s',1,'p_s','logic_grammar.py',79),
  ('ciclo -> para var de e ate e faca com_list ; fimpara','ciclo',10,'p_ciclo','logic_grammar.py',85),
  ('ciclo -> enquanto n faca com_list ; fimenquanto','ciclo',6,'p_ciclo2','logic_grammar.py',93),
  ('comando -> e','comando',1,'p_comando1','logic_grammar.py',103),
  ('comando -> ciclo','comando',1,'p_comando1','logic_grammar.py',104),
  ('comando -> var assign e','comando',3,'p_comando2','logic_grammar.py',108),
  ('comando -> escreva ( e_list )','comando',4,'p_comando3','logic_grammar.py',113),
  ('comando -> leia ( var_list )','comando',4,'p_comando4','logic_grammar.py',118),
  ('comando -> vartype : var_list','comando',3,'p_comando5','logic_grammar.py',122),
  ('comando -> se e entao com_list ; senao com_list ; fimse','comando',9,'p_comando6','logic_grammar.py',128),
  ('comando -> se e entao com_list ; fimse','comando',6,'p_comando7','logic_grammar.py',134),
  ('com_list -> comando','com_list',1,'p_com_list','logic_grammar.py',141),
  ('com_list -> com_list ; comando','com_list',3,'p_com_list','logic_grammar.py',142),
  ('e_list -> e','e_list',1,'p_e_list','logic_grammar.py',152),
  ('e_list -> e_list , e','e_list',3,'p_e_list','logic_grammar.py',153),
  ('e -> var','e',1,'p_e1','logic_grammar.py',162),
  ('e -> ( e )','e',3,'p_e2','logic_grammar.py',166),
  ('e -> b','e',1,'p_e3','logic_grammar.py',170),
  ('e -> n','e',1,'p_e3','logic_grammar.py',171),
  ('e -> string','e',1,'p_e3','logic_grammar.py',172),
  ('e -> var ( e_list )','e',4,'p_e4','logic_grammar.py',176),
  ('e -> var ( )','e',3,'p_e4','logic_grammar.py',177),
  ('n -> nr','n',1,'p_n1','logic_grammar.py',185),
  ('n -> - e','n',2,'p_n1','logic_grammar.py',186),
  ('n -> ( n )','n',3,'p_n2','logic_grammar.py',190),
  ('n -> e + e','n',3,'p_n3','logic_grammar.py',194),
  ('n -> e - e','n',3,'p_n3','logic_grammar.py',195),
  ('n -> e * e','n',3,'p_n3','logic_grammar.py',196),
  ('n -> e / e','n',3,'p_n3','logic_grammar.py',197),
  ('n -> e < e','n',3,'p_n4','logic_grammar.py',201),
  ('n -> e leq e','n',3,'p_n4','logic_grammar.py',202),
  ('n -> e > e','n',3,'p_n4','logic_grammar.py',203),
  ('n -> e geq e','n',3,'p_n4','logic_grammar.py',204),
  ('n -> e = e','n',3,'p_n4','logic_grammar.py',205),
  ('n -> e dif e','n',3,'p_n4','logic_grammar.py',206),
  ('b -> f','b',1,'p_b1','logic_grammar.py',212),
  ('b -> e or e','b',3,'p_b1','logic_grammar.py',213),
  ('b -> e and e','b',3,'p_b1','logic_grammar.py',214),
  ('b -> e xor e','b',3,'p_b1','logic_grammar.py',215),
  ('f -> true','f',1,'p_f1','logic_grammar.py',224),
  ('f -> false','f',1,'p_f2','logic_grammar.py',228),
  ('f -> not f','f',2,'p_f3','logic_grammar.py',232),
  ('var_list -> var','var_list',1,'p_var_list','logic_grammar.py',238),
  ('var_list -> var_list , var','var_list',3,'p_var_list','logic_grammar.py',239),
  ('args -> <empty>','args',0,'p_args','logic_grammar.py',249),
  ('args -> var_list','args',1,'p_args','logic_grammar.py',250),
]
