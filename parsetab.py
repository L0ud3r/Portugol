...
_lr_productions = [
  ...
  ('portugol -> inicio code','portugol',2,'p_portugol2','logic_grammar.py',49),
  ('func_list -> func','func_list',1,'p_func_list','logic_grammar.py',54),
  ('func_list -> func_list ; func','func_list',3,'p_func_list','logic_grammar.py',55),
  ('func -> funcao var ( args ) com_list ; fimfuncao','func',8,'p_func','logic_grammar.py',65),
  ('code -> s','code',1,'p_code1','logic_grammar.py',74),
  ('code -> code ; s','code',3,'p_code2','logic_grammar.py',79),
  ('s -> comando','s',1,'p_s','logic_grammar.py',84),
  ('s -> fim','s',1,'p_s','logic_grammar.py',85),
  ('ciclo -> para var de e ate e faca com_list ; fimpara','ciclo',10,'p_ciclo','logic_grammar.py',90),
  ('ciclo -> enquanto n faca com_list ; fimenquanto','ciclo',6,'p_ciclo2','logic_grammar.py',99),
  ('comando -> e','comando',1,'p_comando1','logic_grammar.py',108),
  ('comando -> ciclo','comando',1,'p_comando1','logic_grammar.py',109),
  ...
  ('comando -> vartype : var_list','comando',3,'p_comando5','logic_grammar.py',129),
  ('comando -> se e entao com_list ; senao com_list ; fimse','comando',9,'p_comando6','logic_grammar.py',136),
  ('comando -> se e entao com_list ; fimse','comando',6,'p_comando7','logic_grammar.py',143),
  ('com_list -> comando','com_list',1,'p_com_list','logic_grammar.py',150),
  ('com_list -> com_list ; comando','com_list',3,'p_com_list','logic_grammar.py',151),
  ('e_list -> e','e_list',1,'p_e_list','logic_grammar.py',160),
  ('e_list -> e_list , e','e_list',3,'p_e_list','logic_grammar.py',161),
  ('e -> var','e',1,'p_e1','logic_grammar.py',169),
  ('e -> ( e )','e',3,'p_e2','logic_grammar.py',174),
  ('e -> b','e',1,'p_e3','logic_grammar.py',179),
  ('e -> n','e',1,'p_e3','logic_grammar.py',180),
  ('e -> string','e',1,'p_e3','logic_grammar.py',181),
  ('e -> var ( e_list )','e',4,'p_e4','logic_grammar.py',186),
  ('e -> var ( )','e',3,'p_e4','logic_grammar.py',187),
  ('n -> nr','n',1,'p_n1','logic_grammar.py',194),
  ('n -> - e','n',2,'p_n1','logic_grammar.py',195),
  ('n -> ( n )','n',3,'p_n2','logic_grammar.py',200),
  ('n -> e + e','n',3,'p_n3','logic_grammar.py',205),
  ('n -> e - e','n',3,'p_n3','logic_grammar.py',206),
  ('n -> e * e','n',3,'p_n3','logic_grammar.py',207),
  ('n -> e / e','n',3,'p_n3','logic_grammar.py',208),
  ('n -> e < e','n',3,'p_n4','logic_grammar.py',213),
  ('n -> e leq e','n',3,'p_n4','logic_grammar.py',214),
  ('n -> e > e','n',3,'p_n4','logic_grammar.py',215),
  ('n -> e geq e','n',3,'p_n4','logic_grammar.py',216),
  ('n -> e = e','n',3,'p_n4','logic_grammar.py',217),
  ('n -> e dif e','n',3,'p_n4','logic_grammar.py',218),
  ('b -> f','b',1,'p_b1','logic_grammar.py',223),
  ('b -> e or e','b',3,'p_b1','logic_grammar.py',224),
  ('b -> e and e','b',3,'p_b1','logic_grammar.py',225),
  ('b -> e xor e','b',3,'p_b1','logic_grammar.py',226),
  ('f -> true','f',1,'p_f1','logic_grammar.py',234),
  ('f -> false','f',1,'p_f2','logic_grammar.py',239),
  ('f -> not f','f',2,'p_f3','logic_grammar.py',244),
  ('var_list -> var','var_list',1,'p_var_list','logic_grammar.py',249),
  ('var_list -> var_list , var','var_list',3,'p_var_list','logic_grammar.py',250),
  ('args -> <empty>','args',0,'p_args','logic_grammar.py',259),
  ('args -> var_list','args',1,'p_args','logic_grammar.py',260),
]
